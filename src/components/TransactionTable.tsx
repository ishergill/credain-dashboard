...
const TransactionTable = () => {
  ...
  }, [setSortedData, sortOrder, sortedColumn]);
    ...
    <div className="mt-8">
      <table className="border rounded-md border-gray-200">
        <thead className="bg-gray-100">
          <tr>
            <th
              className="px-6 py-3 text-left text-xs font-medium text-gray-800 tracking-wider cursor-pointer"
            ...
            <th className="px-6 py-3 text-left text-xs font-medium text-gray-800 tracking-wider">
              Action
            </th>
          </tr>
        </thead>
          ...
          {sortedData.map((transaction, index) => {
            return (
              <tr key={index}>
                ...
                <td className="px-6 py-3 text-left text-xs font-medium  text-blue-700 tracking-wider">
